...
public class CancelRideMockWhiteTest {
    ...
    public void tearDown() {
        // Any cleanup can be performed here if needed
    }
    ...
    public void test1() {
        ...
        when(db.find(Ride.class, ride1.getRideNumber())).thenReturn(ride1);
    ...
    public void test2() {
        ...
        when(db.find(Ride.class, ride2.getRideNumber())).thenReturn(ride2);
    ...
    public void test3() {
        ...
        when(db.find(Ride.class, ride3.getRideNumber())).thenReturn(ride3);
    ...
    public void test4() {
        ...
        when(db.find(Ride.class, ride4.getRideNumber())).thenReturn(ride4);
